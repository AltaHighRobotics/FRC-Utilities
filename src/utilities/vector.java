...
/** A class for creating and working with 2D and 3D vectors
 * Each instance contains an x, y, and optionally a z value, along with various functions for performing standard math operations on itself.
 * 
 *  @author Ian
...
public class vector {
     ...
     * @return A new vector containing the result of the addition. The result will be the same type as the parent (2D or 3D).
     */
     ...
     * @return A new vector containing the result of the subtraction. The result will be the same type as the parent (2D or 3D).
     */
     ...
     * @return A new vector3D containing the result of the multiplication. The result will be the same type as the parent (2D or 3D).
     */
     ...
     * @return A new vector3D containing the result of the division. The result will be the same type as the parent (2D or 3D).
     */
     ...
     * 
     * @return A new vector3D with the same direction as the parent, but with a length of 1. The result will be the same type as the parent (2D or 3D).
     */
     ...
     * 
     * @return A double representing the average of the parent vector's components. This is only useful in a few cases, so ensure this is the right function. This value is also stored in the parent to avoid extra calculations when possible.
     */
    public double average() {
